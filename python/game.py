...
class Porker(object) :
    ...
    def image_road(self) :
        ...
        self.button_fold = pygame.image.load("%splay_button_blue.png" % b_root).convert_alpha()
        self.button_fold_on = pygame.image.load("%splay_button_blue_fade.png" % b_root).convert_alpha()
